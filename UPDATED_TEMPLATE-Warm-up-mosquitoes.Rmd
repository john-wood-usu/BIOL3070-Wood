...
Mosquitoes feast on the blood of various organisms, causing their host's DNA to be found in the mosquito's blood. Because the virus is transmitted by mosquitoes, analyzing mosquito blood offers great insights into how the virus spreads. To analyze, extracted blood will undergo PCR, which multiplies the DNA. The multiplied DNA can then be sequenced and matched to an online data bank to discover which host the mosquito fed on.
...
## Questions  
Which species act as large reservoirs of west nile virus?

## Hypothesis 
Small, common birds are the largest reservior of west nile virus.
  
## Prediction
Areas with west nile virus have a greater amount of small, common birds.
...
# METHODS
## Data Collection
Mosquito collection traps were placed in two main area types: #1 and #2. After waiting for x amount of time, we decided 
