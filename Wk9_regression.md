...
- Compare across:
  ...
  1)  Before 1883 The p-value is less than 2e-16, suggesting a very
      statistically significant correlation.

  2)  After 1883 The p-value is 5.33e-15, suggesting a very
      statistically significant correlation.
...
- Compare across:
  ...
  1)  Before 1883 The slope is 0.025738, meaning that life expectancy
      increases by 0.025738 years each passing year.

  2)  After 1883 The slope is 0.2729, meaning that life expectancy
      increases by 0.2729 years each passing year. The annual increase
      in life expectancy jumped nearly ten-fold after 1883.
...
In 1883, Koch proved found reliable evidence to support the germ theory.
This resulted in significantly better medical diagnoses, sterilization
practices, and treatment. As healthcare improved worldwide, people began
living longer, and life expectancy increased dramatically. Thus, the
strength of the correlation between year and life expectancy is much
higher in the dataset after 1883.
